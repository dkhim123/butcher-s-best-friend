...
BEGIN
  -- pay_order (orders → sale) already deducted the stock at order time and sets
  -- this flag, so we don't deduct twice when the order's items become sale_items.
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║ 6.5 ORDERS — order now, pay later (open tabs)                ║
-- ╚══════════════════════════════════════════════════════════════╝
-- Orders live in their OWN tables so they never touch sales/reports/revenue
-- until paid. Stock deducts when items are ORDERED (consumed); pay_order then
-- converts the order into a sale, moving the items and re-pointing their stock
-- movements (no double deduction). See migrations/006 for the full rationale.
